...
f = open('test_data/sample10_period3.txt')
...
#period 1
ghp1 = [-0.0012,0.1547,1.6295,0.0014,1.155e-05,-6.2260,0.6176]

gh_pt = gohawks_nfollowers[5]*ghp1[0]+gohawks_retweets[5]*ghp1[1]+gohawks_rs[5]*ghp1[2]+gohawks_friends[5]*ghp1[3]+ gohawks_fav[5]*ghp1[4]+gohawks_tweets[5]*ghp1[5]+ghp1[6]

gpp1 = [-0.0010,0.0303,0.5997,0.0005,7.197e-05,-1.7652,0.6427]

gp_pt = gop_nfollowers[5]*gpp1[0]+gop_retweets[5]*gpp1[1]+gop_rs[5]*gpp1[2]+gop_friends[5]*gpp1[3]+ gop_fav[5]*gpp1[4]+gop_tweets[5]*gpp1[5]+gpp1[6]

nflp1 = [-1.3e-06,-0.0028,0.4377,0.0001,-5.834e-05,-1.2183,42.5543]

nfl_pt = nfl_nfollowers[5]*nflp1[0]+nfl_retweets[5]*nflp1[1]+nfl_rs[5]*nflp1[2]+nfl_friends[5]*nflp1[3]+ nfl_fav[5]*nflp1[4]+nfl_tweets[5]*nflp1[5]+nflp1[6]

patp1 = [2.685e-05,-0.2712,0.8647,-5.332e-05,-0.0003,-2.2127,-7.1637]

pat_pt = pat_nfollowers[5]*patp1[0]+pat_retweets[5]*patp1[1]+pat_rs[5]*patp1[2]+pat_friends[5]*patp1[3]+ pat_fav[5]*patp1[4]+pat_tweets[5]*patp1[5]+patp1[6]

sb49p1 = [1.686e-06,0.0046,3.2442,2.79e-05,0.0003,-14.1544,62.4438]

sb49_pt = sb49_nfollowers[5]*sb49p1[0]+sb49_retweets[5]*sb49p1[1]+sb49_rs[5]*sb49p1[2]+sb49_friends[5]*sb49p1[3]+ sb49_fav[5]*sb49p1[4]+sb49_tweets[5]*sb49p1[5]+sb49p1[6]

sbp1 = [8.315e-06,-0.0194,1.0608,1.743e-05,-0.0002,-3.8678,129.2791]

sb_pt = sb_nfollowers[5]*sbp1[0]+sb_retweets[5]*sbp1[1]+sb_rs[5]*sbp1[2]+sb_friends[5]*sbp1[3]+ sb_fav[5]*sbp1[4]+sb_tweets[5]*sbp1[5]+sbp1[6]

pt3 = sum([abs(gh_pt), abs(gp_pt), abs(nfl_pt), abs(pat_pt), abs(sb49_pt), abs(sb_pt)])
print pt3