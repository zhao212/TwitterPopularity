...
#period 1
ghp1 = [-0.0001, -0.1484, 2.6178, 0.0012, 0.0022, -17.0384, 120.9152]
...
gpp1 = [-0.0001, -0.4068, -0.7491, 0.0003, 2.328e-05, 4.9123, 4.7542]
...
nflp1 = [2.919e-05, 0.0322, -0.0208, -0.0001, -0.0001, 0.8962, 85.5503]
...
patp1 = [1.25e-05, 0.0416, 2.4251, 0.0009, 0.0003, -12.1919, 61.8752]
...
sb49p1 = [-4.808e-06, 0.0515, 1.2450, -0.0003, 0.0001, -4.7670, 7.1971]
...
sbp1 = [2.378e-06, -0.0812, -0.4601, 0.0006, 2.589e-5, 2.1309, 172.5125]
...
pt1 = sum([abs(gh_pt), abs(gp_pt), abs(nfl_pt), abs(pat_pt), abs(sb49_pt), abs(sb_pt)])
print pt1
